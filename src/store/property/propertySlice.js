...
export const getPropertiesbyRegion = createAsyncThunk(
  "property/getPropertiesbyRegion",
  async (_, thunkAPI) => {
    try {
...
export const propertySlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(getPropertiesbyRegion.pending, (state) => {
        state.isLoading = true;
      })
      .addCase(getPropertiesbyRegion.fulfilled, (state, action) => {
