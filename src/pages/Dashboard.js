...
import {getUsersbyRegion} from "../store/user/userSlice"
import {getPropertiesbyRegion} from "../store/property/propertySlice"
import {getTransactionsbyregion} from "../store/transaction/transactionSlice"
...
const Dashboard = () => {
  ...
  const {rents}=useSelector((state)=>state.transaction) 
  ...
  return (
    <div className="p-10 bg-gray-100 dark:bg-gray-900 min-h-screen">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        {/* Total Earnings */}
        <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
          <h2 className="text-gray-600 dark:text-gray-200 font-bold">Total Transaction</h2>
          <div className="mt-2">
            <p className="text-2xl font-bold text-gray-800 dark:text-gray-100">
              {rents?.length}
